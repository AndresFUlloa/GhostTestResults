...
describe('page test set - a priori data set generation', function() {
    beforeEach(function() {
    ...
    it('Create page and publish', function(){
        ...
        let contenido= pageData['description'];
    ...
    it('Edit page', function(){
        ...
        NewPageUI.editPage(pageName,pageData["description"] );
        NewPageUI.goToPages();
    ...
    it('Create page with content', function(){
          ...
          let pageName = pageData["name"]
          NewPageUI.createPage(pageName,pageData["description"],pageData["url"] );
          PublishPageUI.finishPublish();
